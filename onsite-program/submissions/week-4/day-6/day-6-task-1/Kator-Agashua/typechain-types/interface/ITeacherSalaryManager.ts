...
export interface ITeacherSalaryManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addTeacher"
      | "getStaff"
...
export interface ITeacherSalaryManager extends BaseContract {
  connect(runner?: ContractRunner | null): ITeacherSalaryManager;
  waitForDeployment(): Promise<this>;

  interface: ITeacherSalaryManagerInterface;
