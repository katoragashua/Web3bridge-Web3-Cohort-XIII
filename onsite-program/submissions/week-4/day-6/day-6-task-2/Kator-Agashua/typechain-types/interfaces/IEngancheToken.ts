...
export interface IEngancheTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface IEngancheToken extends BaseContract {
  connect(runner?: ContractRunner | null): IEngancheToken;
  waitForDeployment(): Promise<this>;

  interface: IEngancheTokenInterface;
